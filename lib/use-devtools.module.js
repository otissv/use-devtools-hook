...
function useDevtools(_ref, initialState, name, reducer) {
  ...
  var stagedActions = useRef([]); // Check if extension is loaded
...
export { useDevtools, useReducerDevtools, useStateDevtools };
//# sourceMappingURL=use-devtools.module.js.map
